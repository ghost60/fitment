  ...
  return (
    <>
      ...
      <section>
        <div className="w-full relative">
          ...
          <img
            ...
            alt=""
          />
          <p className="absolute top-1/2 left-1/4 text-white text-2xl">
      ...
      <section className="flex flex-col items-center">
        ...
        <div className="w-4/5">
          <ul className="flex flex-wrap justify-center px-10">
            <li className="flex flex-col items-center justify-center bg-blue-500 h-60 md:w-1/4 sm:1/2 p-3 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
              <p className="text-white text-xl font-medium my-1.5">前期咨询</p>
              <p className="text-white text-center">
                以用户为中心解答业主各类设计相关疑问
              </p>
            </li>
            <li className="flex flex-col items-center justify-center bg-red-500 h-60 md:w-1/4 sm:1/2 p-3 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
              <p className="text-white text-xl font-medium my-1.5">硬装设计</p>
              <p className="text-white text-center">
                提供全套硬装设计和采购方案
              </p>
            </li>
            <li className="flex flex-col items-center justify-center bg-green-500 h-60 md:w-1/4 sm:1/2 p-3 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
              <p className="text-white text-xl font-medium my-1.5">施工跟进</p>
              <p className="text-white text-center">
                全程跟进施工过程，并负责技术交底
              </p>
            </li>
            <li className="flex flex-col items-center justify-center bg-purple-500 h-60 md:w-1/4 sm:1/2 p-3 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
      ...
      <section className="flex flex-col items-center bg-green-300 pb-14">
        ...
        <div className="w-4/5">
          <ul className="flex flex-wrap">
            <li className="flex w-1/2 px-2 my-2">
      ...
      <section className="flex flex-col items-center mb-12">
        <span className="text-2xl font-medium mt-14">我们已为超过200个楼盘的客户提供室内设计方案</span>
        <span className="text-2xl font-medium my-2">累计超过1000个设计案例</span>
      </section>
      <Footer />
    </>
  );
